...
test.describe("Pet store API Tests", () => {
  ...
  test("should create a new pet", { tag: ["@smoke"] }, async () => {
  ...
  test("should update an existing pet", { tag: ["@smoke"] }, async () => {
    const pet: Pet = DataGenerator.pet();
  ...
  test("should delete an existing pet", { tag: ["@smoke"] }, async () => {
    const pet: Pet = DataGenerator.pet();
    await petApi.createPet(pet);
  ...
  test("should find pets by status", { tag: ["@smoke"] }, async () => {
    const pet: Pet = DataGenerator.pet();
    await petApi.createPet(pet);
